...
class tree {
 public :
  ...
  TF1* E_corr_hit =
    new TF1("E_corr_hit",Form("(x-%f)/%f",8.4097,0.810995),0,5000);
  TF1* E_corr_clust =
    new TF1("E_corr_clust","3.63095e-9*sqrt(1.007e21*x + 1.558e24) - 4556.22",0,5000);
...
double tree::Ec(double E){
  ...
  return E_corr_clust->Eval(E_corr_hit->Eval(E));
